...
function tokyo_tm_service_popup () {
    ...
    button.on('click', function () {
        ...
        modalBox.find('.service_popup_informations').prepend('<div class="image"><img src="{{ asset("storage/tokyo/img/thumbs/4-2.jpg") }}" alt="" /><div class="main" data-img-url="' + elImage + '"></div></div>');
        tokyo_tm_data_images();
...
function tokyo_tm_modalbox_portfolio () {
    ...
    button.on('click', function () {
        ...
        modalBox.addClass('opened');
        modalBox.find('.description_wrap').html(details);
        modalBox.find('.popup_details').prepend('<div class="top_image"><img src="{{ asset("storage/tokyo/img/thumbs/4-2.jpg") }}" alt="" /><div class="main" data-img-url="' + image + '"></div></div>');
